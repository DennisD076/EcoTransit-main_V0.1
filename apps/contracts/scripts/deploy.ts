...
export async function deploy() {
    ...
    const rewardAmount = ethers.parseUnits("1", 18); // 1000 tokens with 18 decimals
    const rewardsAmountResult = await (await ecoEarnInstance.setRewardsAmount(rewardAmount)).wait();
