    ...
    async (files: File[]) => {
      ...
      if (!account) {
        toast({
          ...
          description: "Please connect your wallet to upload tickets",
          status: "warning",
          duration: 5000,
          isClosable: true,
        });
      ...
      try {
        ...
        toast({
          title: "Upload failed",
          description: "There was an error processing your ticket. Please try again.",
          status: "error",
          duration: 5000,
          isClosable: true,
        });
        ...
        >
          <VStack spacing={4}>
            <Text color="gray.600" fontSize="sm">
              Please connect your wallet to upload tickets
            </Text>
            <Button
              onClick={open}
              bg="green.500"
      ...
      >
        ...
        {isLoading ? (
          <VStack spacing={3}>
            ...
            <Text color="gray.600" fontSize="sm">Processing your ticket...</Text>
          </VStack>
        ) : (
          <VStack spacing={3}>
